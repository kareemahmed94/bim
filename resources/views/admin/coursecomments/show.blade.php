                ...
                @foreach ($comments as $comment)
                    ...
                    <!-- Comment Row -->
                        <div class="d-flex flex-row comment-row">
                            <div class="p-2"><span class="round"><img src="{{asset('assets/images/users/1.jpg')}}"
                        ...
                        <form action="{{route('coursecomment.update',$comment->id)}}" method="POST"
                            ...
                            @if ($comment->status == 1)
                                <input type="submit" name="unapprove" class="btn btn-danger btn-small"
                                       value="Un Approve">
                            @endif
