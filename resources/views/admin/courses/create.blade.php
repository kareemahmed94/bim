                    ...
                    <form action="{{route('course.store')}}" enctype="multipart/form-data" method="POST"
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                ...
                                <textarea name="details_ar" class="form-control" rows="3"
                            ...
                            <div class="form-group row">
                                ...
                                <textarea name="details_en" class="form-control" rows="3"
                                ...
                                <select name="category_id" class="form-control">
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{$category->id}}"
                                                class="form-control">{{$category->name_en}}</option>
                                    @endforeach
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-info mb-4"><i class="fa fa-check"></i>Create Course
                                </button>
                            </div>
